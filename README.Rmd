...
### yt.related()
This function collects a list of up to 50 videos that are related to another video. The output is an dataframe in the RStudio environment and a CSV file titled: "related_(video ID)_(date-time of collection).csv".
```{r echo=FALSE}
...
### yt.VideoComments()
This function collects all the comments on a video on YouTube, including replies to comments.  The function requires a video ID.  The output is a dataframe in the RStudio environment per the designated name and a CSV file titled: "comments_(video ID)_(date-time of collection).csv".
```{r echo = FALSE}
