...
golf <- yt.search(term="golf", 
                  ...
                  published_before = "2017-03-07T00:00:00Z")
```
The results for this example include 431 videos and the following information about each video:  video ID, date-time posted, channel ID, title, description, and channel title.
